...
$(document).ready(function () {
    ...
    function Move() {
        ...
        if ($bg1.hasClass("inview")) {
            bg1.css({'backgroundPosition': newPos(50, windowHeight, pos, -200, 0.4)});
        }
        if ($bg2.hasClass("inview")) {
            bg2.css({'backgroundPosition': newPos(50, windowHeight, pos, -600, -0.25)});
        }
        if ($bg3.hasClass("inview")) {
            bg3.css({'backgroundPosition': newPos(50, windowHeight, pos, 700, 0.12)});
        }
        if ($bg4.hasClass("inview")) {
            bg4.css({'backgroundPosition': newPos(50, windowHeight, pos, 800, -0.18)});
        }
        if ($bg5.hasClass("inview")) {
            bg5.css({'backgroundPosition': newPos(50, windowHeight, pos, 4500, 0.06)});
        }
